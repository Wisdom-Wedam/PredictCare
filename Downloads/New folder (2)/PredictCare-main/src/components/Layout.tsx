...
export default function Layout({
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 flex flex-col font-sans overflow-x-hidden">
      ...
      <div 
        aria-hidden="true"
        className="fixed left-0 top-0 bottom-0 w-36 sm:w-56 md:w-72 lg:w-88 xl:w-[26rem] pointer-events-none z-0 overflow-hidden select-none opacity-100 sm:opacity-105"
      >
      ...
      <div 
        aria-hidden="true"
        className="fixed right-0 top-0 bottom-0 w-36 sm:w-56 md:w-72 lg:w-88 xl:w-[26rem] pointer-events-none z-0 overflow-hidden select-none opacity-100 sm:opacity-105"
      >
        <div className="h-1/2 w-full relative">
          <img
